export default function Hero() {
  return (
    <>
      ...
      <h3>The Rules</h3>
      <p>
        To comlete this program, you <b>MUST</b>follow 3 simple rules:
      </p>
      <ul className="rules-list">
        <div className="rule-item">
          ...
          <p>Ensure that you are taking rest day where necessary</p>
        </div>
        <div className="rule-item">
          <p>
            <b>Reps</b>
      ...
      <p>
        This training plan uses a structure knows as the <b>Bro Split</b>, and
